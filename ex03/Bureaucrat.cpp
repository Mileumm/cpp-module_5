...
void Bureaucrat::signForm(AForm& form)
{
	...
	{
		std::cout << _name << " couldn’t sign this form that targets" << form.getTarget() << " because " << e.what() << std::endl;
	}
}
...
void Bureaucrat::executeForm(AForm const & form) const
{
	...
	{
		std::cout << _name << " can't executed this form that targets " << form.getTarget() << " because " << e.what() << std::endl;
	}
}
